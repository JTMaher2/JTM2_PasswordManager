...
class Build : NukeBuild
{
    ...
    private const string prodViewsPath = "/DesktopModules/JTM2_PasswordsStencilJS/resources/scripts/jtm-jtm2-passwordsstenciljs/";
    ...
    Target DeployFrontEnd => _ => _
        ...
        .Executes(() =>
        {
            var scriptsDestination = RootDirectory / "resources" / "scripts" / "jtm-jtm2-passwordsstenciljs";
            EnsureCleanDirectory(scriptsDestination);
            CopyDirectoryRecursively(RootDirectory / "module.web" / "dist" / "jtm-jtm2-passwordsstenciljs", scriptsDestination, DirectoryExistsPolicy.Merge);
        });
