...
namespace JTMaher.Modules.JTMPasswordsStencilJS.Services
{
    ...
    using static JTMaher.Modules.JTMPasswordsStencilJS.ViewModels.LocalizationViewModel;
    ...
    public class LocalizationService : ILocalizationService
    {
        ...
        private string ResourceFileRoot
        {
            get
            {
                ...
                {
                    this.resourceFileRoot = "~/DesktopModules/JTM2_PasswordsStencilJS/resources/App_LocalResources/";
                }
        ...
        public LocalizationService()
        {
            ...
            this.cacheKey = "JTMaher.Modules.JTMPasswordsStencilJS" + "_Localization_" + Thread.CurrentThread.CurrentCulture;
        ...
        private LocalizationViewModel HydrateViewModel()
        {
            ...
            var ui = new UIInfo
            {
                ...
                M_StrMasterPassword = this.GetString("M_StrMasterPassword", "UI.resx"),
