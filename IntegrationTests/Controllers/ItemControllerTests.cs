...
namespace IntegrationTests.Controllers
{
    public class ItemControllerTests : FakeDataContext
    {
        ...
        [Theory]
        [InlineData("name1", "description1", "strMasterPassword1")]
        [InlineData("name2", "description2", "strMasterPassword2")]
        public async Task CreateItem_Creates(string name, string description, string strMasterPassword)
        {
        ...
        public async Task GetItemsPage_GetsProperPages(int amount, int expectedPages)
        {
            ...
            var dto = new GetItemsPageDTO { M_StrMasterPassword = "test", Query = "", Page = 1, PageSize = 10, Descending = true };
        ...
        public async Task GetItemsPage_Page0_DefaultsToPage1()
        {
            ...
            var result = await this.itemController.GetItemsPage(
                new GetItemsPageDTO { M_StrMasterPassword = "test", Query = "", Page = 0, PageSize = 10, Descending = true });
        ...
        public async Task GetItemsPage_PageSize0_DefaultsTo1()
        {
            ...
            var result = await this.itemController.GetItemsPage(
                new GetItemsPageDTO { M_StrMasterPassword = "test", Query = "", Page = 1, PageSize = 0 });
        ...
        public async Task GetItemsPage_50Items_GetsProperly()
        {
            ...
            var results = await this.itemController.GetItemsPage(
                new GetItemsPageDTO { M_StrMasterPassword = "test", Query = "", Page = 1, PageSize = 50 });
        ...
        public async Task GetItemsPage_SortsAscending()
        {
            ...
            var result = await this.itemController.GetItemsPage(
                new GetItemsPageDTO { M_StrMasterPassword = "test", Query = "", Page = 1, PageSize = 10 });
        ...
        public async Task GetItemsPage_SortsDescending()
        {
            ...
            var result = await this.itemController.GetItemsPage(
                new GetItemsPageDTO { M_StrMasterPassword = "test", Query = "", Page = 1, PageSize = 10, Descending = true });
        ...
        public async Task GetItemsPage_Query_Filters(string query, int expectedResults)
        {
            ...
            var result = await this.itemController.GetItemsPage(
                new GetItemsPageDTO { M_StrMasterPassword = "test", Query = query, Page = 1, PageSize = 10 });
